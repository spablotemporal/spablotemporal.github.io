...
For the workshop we will be using mainly R and R studio, but other tools such as QGIS and Google Maps will also be used to demonstrate the applications of the results. 
