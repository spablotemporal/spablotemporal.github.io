...
knitr::include_graphics(rep('Images/Model.png'))
```
...
The $\beta_i$ parameter is a time dependent estimation based on the $R_0$, the effect of interventions and the seasonality.  
...
$\beta_i(t) = R_0(1+\epsilon \cos(2\pi(t-t_{peak})))/365$
